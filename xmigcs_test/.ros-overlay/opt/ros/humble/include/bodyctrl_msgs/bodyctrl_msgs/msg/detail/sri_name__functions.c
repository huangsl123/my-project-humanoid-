...
bodyctrl_msgs__msg__SriName__create()
{
  ...
  bodyctrl_msgs__msg__SriName * msg = (bodyctrl_msgs__msg__SriName *)allocator.allocate(sizeof(bodyctrl_msgs__msg__SriName), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bodyctrl_msgs__msg__SriName));
  bool success = bodyctrl_msgs__msg__SriName__init(msg);
  if (!success) {
...
bodyctrl_msgs__msg__SriName__destroy(bodyctrl_msgs__msg__SriName * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bodyctrl_msgs__msg__SriName__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bodyctrl_msgs__msg__SriName__Sequence__init(bodyctrl_msgs__msg__SriName__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__msg__SriName * data = NULL;

  if (size) {
    data = (bodyctrl_msgs__msg__SriName *)allocator.zero_allocate(size, sizeof(bodyctrl_msgs__msg__SriName), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bodyctrl_msgs__msg__SriName__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bodyctrl_msgs__msg__SriName__fini(&data[i - 1]);
      }
...
bodyctrl_msgs__msg__SriName__Sequence__fini(bodyctrl_msgs__msg__SriName__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bodyctrl_msgs__msg__SriName__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__msg__SriName__Sequence * array = (bodyctrl_msgs__msg__SriName__Sequence *)allocator.allocate(sizeof(bodyctrl_msgs__msg__SriName__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bodyctrl_msgs__msg__SriName__Sequence__init(array, size);
  if (!success) {
...
bodyctrl_msgs__msg__SriName__Sequence__destroy(bodyctrl_msgs__msg__SriName__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bodyctrl_msgs__msg__SriName__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bodyctrl_msgs__msg__SriName__Sequence__are_equal(const bodyctrl_msgs__msg__SriName__Sequence * lhs, const bodyctrl_msgs__msg__SriName__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bodyctrl_msgs__msg__SriName__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bodyctrl_msgs__msg__SriName__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bodyctrl_msgs__msg__SriName);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bodyctrl_msgs__msg__SriName * data =
      (bodyctrl_msgs__msg__SriName *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bodyctrl_msgs__msg__SriName__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bodyctrl_msgs__msg__SriName__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bodyctrl_msgs__msg__SriName__copy(
