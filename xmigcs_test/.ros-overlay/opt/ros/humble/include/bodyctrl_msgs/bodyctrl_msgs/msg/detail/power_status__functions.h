...
#ifndef BODYCTRL_MSGS__MSG__DETAIL__POWER_STATUS__FUNCTIONS_H_
#define BODYCTRL_MSGS__MSG__DETAIL__POWER_STATUS__FUNCTIONS_H_
 ...
 * calls
 * bodyctrl_msgs__msg__PowerStatus__init().
...
/**
 * It calls
 * bodyctrl_msgs__msg__PowerStatus__fini()
 ...
 * bodyctrl_msgs__msg__PowerStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bodyctrl_msgs__msg__PowerStatus__Sequence__fini()
 * on the array,
...
#endif  // BODYCTRL_MSGS__MSG__DETAIL__POWER_STATUS__FUNCTIONS_H_
