...
#ifndef BODYCTRL_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_
#define BODYCTRL_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_
...
inline void to_yaml(
  const bodyctrl_msgs::msg::Imu & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bodyctrl_msgs::msg::Imu & msg)
{
  return bodyctrl_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bodyctrl_msgs::msg::Imu>()
{
  return "bodyctrl_msgs::msg::Imu";
}

template<>
inline const char * name<bodyctrl_msgs::msg::Imu>()
{
  return "bodyctrl_msgs/msg/Imu";
}

template<>
struct has_fixed_size<bodyctrl_msgs::msg::Imu>
  : std::integral_constant<bool, has_fixed_size<bodyctrl_msgs::msg::Euler>::value && has_fixed_size<geometry_msgs::msg::Quaternion>::value && has_fixed_size<geometry_msgs::msg::Vector3>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<bodyctrl_msgs::msg::Imu>
  : std::integral_constant<bool, has_bounded_size<bodyctrl_msgs::msg::Euler>::value && has_bounded_size<geometry_msgs::msg::Quaternion>::value && has_bounded_size<geometry_msgs::msg::Vector3>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<bodyctrl_msgs::msg::Imu>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BODYCTRL_MSGS__MSG__DETAIL__IMU__TRAITS_HPP_
