...
bodyctrl_msgs__srv__XSensImuInit_Request__init(bodyctrl_msgs__srv__XSensImuInit_Request * msg)
{
  ...
  // dev_name
  if (!rosidl_runtime_c__String__init(&msg->dev_name)) {
    bodyctrl_msgs__srv__XSensImuInit_Request__fini(msg);
    return false;
  }
  return true;
}
...
bodyctrl_msgs__srv__XSensImuInit_Request__fini(bodyctrl_msgs__srv__XSensImuInit_Request * msg)
{
  ...
  // dev_name
  rosidl_runtime_c__String__fini(&msg->dev_name);
}
  ...
  bodyctrl_msgs__srv__XSensImuInit_Request * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->dev_name), &(output->dev_name)))
  {
    return false;
  }
  return true;
...
bodyctrl_msgs__srv__XSensImuInit_Request__create()
{
  ...
  bodyctrl_msgs__srv__XSensImuInit_Request * msg = (bodyctrl_msgs__srv__XSensImuInit_Request *)allocator.allocate(sizeof(bodyctrl_msgs__srv__XSensImuInit_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bodyctrl_msgs__srv__XSensImuInit_Request));
  bool success = bodyctrl_msgs__srv__XSensImuInit_Request__init(msg);
  if (!success) {
...
bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__init(bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__srv__XSensImuInit_Request * data = NULL;

  if (size) {
    data = (bodyctrl_msgs__srv__XSensImuInit_Request *)allocator.zero_allocate(size, sizeof(bodyctrl_msgs__srv__XSensImuInit_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bodyctrl_msgs__srv__XSensImuInit_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bodyctrl_msgs__srv__XSensImuInit_Request__fini(&data[i - 1]);
      }
...
bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__fini(bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bodyctrl_msgs__srv__XSensImuInit_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * array = (bodyctrl_msgs__srv__XSensImuInit_Request__Sequence *)allocator.allocate(sizeof(bodyctrl_msgs__srv__XSensImuInit_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__init(array, size);
  if (!success) {
...
bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__destroy(bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bodyctrl_msgs__srv__XSensImuInit_Request__Sequence__are_equal(const bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * lhs, const bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bodyctrl_msgs__srv__XSensImuInit_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bodyctrl_msgs__srv__XSensImuInit_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bodyctrl_msgs__srv__XSensImuInit_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bodyctrl_msgs__srv__XSensImuInit_Request * data =
      (bodyctrl_msgs__srv__XSensImuInit_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bodyctrl_msgs__srv__XSensImuInit_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bodyctrl_msgs__srv__XSensImuInit_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bodyctrl_msgs__srv__XSensImuInit_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__srv__XSensImuInit_Response * msg = (bodyctrl_msgs__srv__XSensImuInit_Response *)allocator.allocate(sizeof(bodyctrl_msgs__srv__XSensImuInit_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bodyctrl_msgs__srv__XSensImuInit_Response));
  bool success = bodyctrl_msgs__srv__XSensImuInit_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
bodyctrl_msgs__srv__XSensImuInit_Response__destroy(bodyctrl_msgs__srv__XSensImuInit_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bodyctrl_msgs__srv__XSensImuInit_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__init(bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__srv__XSensImuInit_Response * data = NULL;

  if (size) {
    data = (bodyctrl_msgs__srv__XSensImuInit_Response *)allocator.zero_allocate(size, sizeof(bodyctrl_msgs__srv__XSensImuInit_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bodyctrl_msgs__srv__XSensImuInit_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        bodyctrl_msgs__srv__XSensImuInit_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__fini(bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      bodyctrl_msgs__srv__XSensImuInit_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * array = (bodyctrl_msgs__srv__XSensImuInit_Response__Sequence *)allocator.allocate(sizeof(bodyctrl_msgs__srv__XSensImuInit_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__destroy(bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bodyctrl_msgs__srv__XSensImuInit_Response__Sequence__are_equal(const bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * lhs, const bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bodyctrl_msgs__srv__XSensImuInit_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bodyctrl_msgs__srv__XSensImuInit_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bodyctrl_msgs__srv__XSensImuInit_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bodyctrl_msgs__srv__XSensImuInit_Response * data =
      (bodyctrl_msgs__srv__XSensImuInit_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bodyctrl_msgs__srv__XSensImuInit_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bodyctrl_msgs__srv__XSensImuInit_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!bodyctrl_msgs__srv__XSensImuInit_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
