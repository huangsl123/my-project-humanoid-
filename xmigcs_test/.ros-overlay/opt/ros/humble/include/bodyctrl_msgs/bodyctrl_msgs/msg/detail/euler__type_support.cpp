...
{
  new (message_memory) bodyctrl_msgs::msg::Euler(_init);
}

void Euler_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bodyctrl_msgs::msg::Euler *>(message_memory);
  typed_message->~Euler();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Euler_message_member_array[3] = {
  {
    ...
    offsetof(bodyctrl_msgs::msg::Euler, roll),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bodyctrl_msgs::msg::Euler, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bodyctrl_msgs::msg::Euler, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Euler_message_members = {
  ...
  "Euler",  // message name
  3,  // number of fields
  sizeof(bodyctrl_msgs::msg::Euler),
...
get_message_type_support_handle<bodyctrl_msgs::msg::Euler>()
{
  return &::bodyctrl_msgs::msg::rosidl_typesupport_introspection_cpp::Euler_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bodyctrl_msgs, msg, Euler)() {
  return &::bodyctrl_msgs::msg::rosidl_typesupport_introspection_cpp::Euler_message_type_support_handle;
}
