...
#ifndef BODYCTRL_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_
#define BODYCTRL_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__bodyctrl_msgs__msg__Imu __attribute__((deprecated))
#else
# define DEPRECATED__bodyctrl_msgs__msg__Imu __declspec(deprecated)
#endif
...
struct Imu_
{
    ...
    euler(_init)
  {
    ...
    {
      this->error = 0ul;
      std::fill<typename std::array<double, 3>::iterator, double>(this->angular_velocity_covariance.begin(), this->angular_velocity_covariance.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->orientation_covariance.begin(), this->orientation_covariance.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->linear_acceleration_covariance.begin(), this->linear_acceleration_covariance.end(), 0.0);
    }
  }
  ...
  using _euler_type =
    bodyctrl_msgs::msg::Euler_<ContainerAllocator>;
  _euler_type euler;
  using _error_type =
    uint32_t;
  _error_type error;
  ...
  Type & set__euler(
    const bodyctrl_msgs::msg::Euler_<ContainerAllocator> & _arg)
  {
    this->euler = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    bodyctrl_msgs::msg::Imu_<ContainerAllocator> *;
  using ConstRawPtr =
    const bodyctrl_msgs::msg::Imu_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      bodyctrl_msgs::msg::Imu_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__bodyctrl_msgs__msg__Imu
    std::shared_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__bodyctrl_msgs__msg__Imu
    std::shared_ptr<bodyctrl_msgs::msg::Imu_<ContainerAllocator> const>
...
using Imu =
  bodyctrl_msgs::msg::Imu_<std::allocator<void>>;
...
#endif  // BODYCTRL_MSGS__MSG__DETAIL__IMU__STRUCT_HPP_
