...
#ifndef BODYCTRL_MSGS__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
#define BODYCTRL_MSGS__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
 ...
 * calls
 * bodyctrl_msgs__msg__MotorStatus__init().
...
/**
 * It calls
 * bodyctrl_msgs__msg__MotorStatus__fini()
 ...
 * bodyctrl_msgs__msg__MotorStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bodyctrl_msgs__msg__MotorStatus__Sequence__fini()
 * on the array,
...
#endif  // BODYCTRL_MSGS__MSG__DETAIL__MOTOR_STATUS__FUNCTIONS_H_
