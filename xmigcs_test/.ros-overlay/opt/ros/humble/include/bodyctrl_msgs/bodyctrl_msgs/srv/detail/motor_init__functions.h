...
#ifndef BODYCTRL_MSGS__SRV__DETAIL__MOTOR_INIT__FUNCTIONS_H_
#define BODYCTRL_MSGS__SRV__DETAIL__MOTOR_INIT__FUNCTIONS_H_
...
/// Initialize srv/MotorInit message.
/**
...
/// Finalize srv/MotorInit message.
/**
...
/// Create srv/MotorInit message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bodyctrl_msgs__srv__MotorInit_Request__init().
...
/// Destroy srv/MotorInit message.
/**
 * It calls
 * bodyctrl_msgs__srv__MotorInit_Request__fini()
...
/// Check for srv/MotorInit message equality.
/**
...
/// Initialize array of srv/MotorInit messages.
/**
...
/// Finalize array of srv/MotorInit messages.
/**
 * It calls
 * bodyctrl_msgs__srv__MotorInit_Request__fini()
...
/// Create array of srv/MotorInit messages.
/**
 * It allocates the memory for the array and calls
 * bodyctrl_msgs__srv__MotorInit_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MotorInit messages.
/**
 * It calls
 * bodyctrl_msgs__srv__MotorInit_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MotorInit message array equality.
/**
...
/// Copy an array of srv/MotorInit messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bodyctrl_msgs__srv__MotorInit_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bodyctrl_msgs
...
/**
 * It calls
 * bodyctrl_msgs__srv__MotorInit_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bodyctrl_msgs
...
/**
 * It allocates the memory for the array and calls
 * bodyctrl_msgs__srv__MotorInit_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bodyctrl_msgs
...
/**
 * It calls
 * bodyctrl_msgs__srv__MotorInit_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BODYCTRL_MSGS__SRV__DETAIL__MOTOR_INIT__FUNCTIONS_H_
