...
class Metaclass_NodeState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'NODE_STATE_IDLE': cls.__constants['NODE_STATE_IDLE'],
            'NODE_STATE_RUNNING': cls.__constants['NODE_STATE_RUNNING'],
        }

    @property
    def NODE_STATE_IDLE(self):
        """Message constant 'NODE_STATE_IDLE'."""
        return Metaclass_NodeState.__constants['NODE_STATE_IDLE']

    @property
    def NODE_STATE_RUNNING(self):
        """Message constant 'NODE_STATE_RUNNING'."""
        return Metaclass_NodeState.__constants['NODE_STATE_RUNNING']
