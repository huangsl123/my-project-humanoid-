...
ROSIDL_GENERATOR_C_IMPORT
PyObject * geometry_msgs__msg__vector3__convert_to_py(void * raw_ros_message);
bool bodyctrl_msgs__msg__euler__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * bodyctrl_msgs__msg__euler__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool bodyctrl_msgs__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyctrl_msgs.msg._imu.Imu", full_classname_dest, 26) == 0);
  }
  bodyctrl_msgs__msg__Imu * ros_message = _ros_message;
  {  // header
  ...
  {  // euler
    ...
    if (!bodyctrl_msgs__msg__euler__convert_from_py(field, &ros_message->euler)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * bodyctrl_msgs__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyctrl_msgs.msg._imu");
  ...
  {  // euler
    PyObject * field = NULL;
    field = bodyctrl_msgs__msg__euler__convert_to_py(&ros_message->euler);
    if (!field) {
      return NULL;
    }
    {
