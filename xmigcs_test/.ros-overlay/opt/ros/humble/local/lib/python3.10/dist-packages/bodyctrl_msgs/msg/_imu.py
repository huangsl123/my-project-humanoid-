...
class Metaclass_Imu(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bodyctrl_msgs.msg import Euler
...
class Imu(metaclass=Metaclass_Imu):
    ...
    _fields_and_field_types = {
        ...
        'euler': 'bodyctrl_msgs/Euler',
        'error': 'uint32',
        'angular_velocity_covariance': 'double[3]',
        'orientation_covariance': 'double[3]',
        'linear_acceleration_covariance': 'double[3]',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Vector3'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['bodyctrl_msgs', 'msg'], 'Euler'),  # noqa: E501
    ...
    def euler(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'euler' field must be a sub message of type 'Euler'"
        self._euler = value
    ...
    def angular_velocity_covariance(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 3, \
                "The 'angular_velocity_covariance' numpy.ndarray() must have a size of 3"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'angular_velocity_covariance' field must be a set or sequence with length 3 and each value of type 'float' and each double in [-.000000, .000000]"
    ...
    def orientation_covariance(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 3, \
                "The 'orientation_covariance' numpy.ndarray() must have a size of 3"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'orientation_covariance' field must be a set or sequence with length 3 and each value of type 'float' and each double in [-.000000, .000000]"
    ...
    def linear_acceleration_covariance(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 3, \
                "The 'linear_acceleration_covariance' numpy.ndarray() must have a size of 3"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'linear_acceleration_covariance' field must be a set or sequence with length 3 and each value of type 'float' and each double in [-.000000, .000000]"
