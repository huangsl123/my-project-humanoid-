...
bool bodyctrl_msgs__msg__node_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyctrl_msgs.msg._node_state.NodeState", full_classname_dest, 39) == 0);
  }
  bodyctrl_msgs__msg__NodeState * ros_message = _ros_message;
  {  // header
...
PyObject * bodyctrl_msgs__msg__node_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyctrl_msgs.msg._node_state");
