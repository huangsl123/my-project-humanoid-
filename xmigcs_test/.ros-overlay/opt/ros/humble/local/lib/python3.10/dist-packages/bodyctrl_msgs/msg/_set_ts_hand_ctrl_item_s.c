...
bool bodyctrl_msgs__msg__set_ts_hand_ctrl_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyctrl_msgs.msg._set_ts_hand_ctrl_item.SetTsHandCtrlItem", full_classname_dest, 58) == 0);
  }
  bodyctrl_msgs__msg__SetTsHandCtrlItem * ros_message = _ros_message;
  {  // vel
  ...
  {  // max_angle
    ...
    assert(PyLong_Check(field));
    ros_message->max_angle = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SetTsHandCtrlItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyctrl_msgs.msg._set_ts_hand_ctrl_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetTsHandCtrlItem");
  ...
  {  // max_angle
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->max_angle);
    {
