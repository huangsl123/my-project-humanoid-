...
bool bodyctrl_msgs__srv__plan_joint_traj__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyctrl_msgs.srv._plan_joint_traj.PlanJointTraj_Request", full_classname_dest, 56) == 0);
  }
  bodyctrl_msgs__srv__PlanJointTraj_Request * ros_message = _ros_message;
  {  // arm_name
  ...
  {  // jerk_percent
    PyObject * field = PyObject_GetAttrString(_pymsg, "jerk_percent");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->jerk_percent = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of PlanJointTraj_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyctrl_msgs.srv._plan_joint_traj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanJointTraj_Request");
  ...
  {  // jerk_percent
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->jerk_percent);
    {
      int rc = PyObject_SetAttrString(_pymessage, "jerk_percent", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool bodyctrl_msgs__srv__plan_joint_traj__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bodyctrl_msgs.srv._plan_joint_traj.PlanJointTraj_Response", full_classname_dest, 57) == 0);
  }
  bodyctrl_msgs__srv__PlanJointTraj_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of PlanJointTraj_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bodyctrl_msgs.srv._plan_joint_traj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanJointTraj_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
